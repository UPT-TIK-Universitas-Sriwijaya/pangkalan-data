        ...
        <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                <h1 class="text-2xl font-semibold text-neutral-900 dark:text-neutral-200"><i
                        class="fa fa-gears me-4"></i>{{ __('Sister Configuration') }}</h1>
            </div>
            <div class="mt-5">
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            ...
                            <div>
                                <label for="id_pengguna"
                                    class="block text-sm font-medium text-neutral-900 dark:text-neutral-200">{{
                                    __('ID Pengguna') }}</label>
                                <input wire:model.live.debounce.300ms="id_pengguna" type="text" id="id_pengguna" class="mt-1 block
                                w-full px-3 py-2 text-sm text-neutral-900 placeholder-neutral-300 border border-neutral-300 rounded-lg
                                focus:outline-none focus:border-cyan-600 dark:text-neutral-200 dark:placeholder-neutral-700
                                dark:border-neutral-700 dark:bg-neutral-800" placeholder="{{ __('ID Pengguna') }}">
                                @error('id_pengguna') <span class="text-red-500">{{ $message }}</span> @enderror
                            </div>
